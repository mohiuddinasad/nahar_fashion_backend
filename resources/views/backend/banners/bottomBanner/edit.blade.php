...
@section('backend_title', 'Secondary Banners | Edit')
        ...
        <div class="col-md-7">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form id="bannerForm" action="{{ route('dashboard.banners.bottom.banner-update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
