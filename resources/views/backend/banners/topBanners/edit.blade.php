...
@section('backend_title', 'Top Banners | Edit')
        ...
        <div class="col-md-7">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom py-3">
                    <h5 class="mb-0 fw-semibold">Add Top Banner</h5>
                </div>
                <div class="card-body p-4">

                    <form id="bannerForm" action="{{ route('dashboard.banners.top.banner-update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
